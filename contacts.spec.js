...
test.describe('Login to See_u platform', () => {
  ...
  test('Create new register form with essential information', async () => {
    await contactsPage.pressPublickFormTab();
    await contactsPage.openPublicRegisterationForm();
    await contactsPage.clickSaveButton()
    expect((await contactsPage.verifySaveChangesMessage()), true);
